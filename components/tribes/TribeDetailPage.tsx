...
const TribeDetailPage: React.FC<TribeDetailPageProps> = (props) => {
  ...
  return (
    <>
      <div className="flex flex-col h-full bg-background rounded-2xl border border-border shadow-md overflow-hidden">
        {/* Header */}
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 bg-background hide-scrollbar">
          <div className="flex flex-col space-y-2">
            {tribe.messages.map(message => {
              const isCurrentUser = message.sender.id === currentUser.id;
              return (
