        ...
        <div className="p-4 md:p-6 relative">
            <div className="flex flex-col sm:flex-row justify-between items-start">
                ...
                <div className="w-full sm:w-auto pt-2 sm:pt-4 flex items-center space-x-2">
                    {isOwnProfile ? (
                        <>
                            <button onClick={() => onNavigate('Settings')} className="w-full sm:w-auto font-semibold px-4 py-2 rounded-lg transition-colors bg-surface text-primary border border-border hover:bg-background flex items-center justify-center space-x-2">
                                <span>Settings</span>
                                <SettingsIcon />
                            </button>
                            <button onClick={() => setEditModalOpen(true)} className="w-full sm:w-auto bg-accent text-accent-text font-semibold px-6 py-2 rounded-lg hover:bg-accent-hover transition-colors">
